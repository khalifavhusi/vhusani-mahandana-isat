...
document.getElementById("displaySearch").addEventListener("click",renderSearch);
...
document.getElementById("clearSearch").addEventListener("click",()=>{searchId.value="";showFamily(null);});
renderSearch();
